...
#
# class ModelComparer:
#     def __init__(self, golden_standard, im_a, fm_a, net_b, im_b,
#                  fm_b, log, outfile: TextIO, precision: float):
...
#         self.fitness = 0
#
#     def get_enabled_transitions(self, pn, m, e, visited_silent=[]):
#         enabled = set()
...
#
#     def get_behavioral_metrics(self, trace, m_a, m_b):
#         # print('trace')
#         # print(trace)
#         # print('len(trace)')
#         # print(len(trace))
